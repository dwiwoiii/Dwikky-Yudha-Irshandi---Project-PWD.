...
<head>
    ...
    <title>Dwikky Yudha Irshandi</title>
...
<header>
    <div class="container">
        <h1><a href="index.php" class="logo">Dwikky Yudha Irshandi</a></h1>
        <ul>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-4">
                <h4>Address</h4>
                <p>Jl. Jakarta Sungai Kunjang, Samarinda</p>
            </div>
            <div class="col-4">
                <h4>Email</h4>
                <p><a href="contact.html">yudhadwikky@gmail.com</a></p>
            </div>
            <div class="col-4">
                <h4>Phone</h4>
                <p>(021) 0123456789</p>
            ...
            <div class="col-4">
                <h4>Mobile</h4>
                <p><a href="contact.html">081254993244</a></p>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <small>Copyright &copy; 2023 - Dwikky Yudha Irshandi. All Rights Reserved.</small>
        </div>
    </footer>
